        ...
        <div className="single-team">
          ...
          <ReactWOW>
            <ul className="member-social-links wow fadeInUp">
              <li>
                <a href={team.sociallink1} className={team.socialicon1}></a>
              </li>
              <li>
                <a href={team.sociallink2} className={team.socialicon2}></a>
              </li>
              <li>
                <a href={team.sociallink3} className={team.socialicon3}></a>
              </li>
              <li>
                <a href={team.sociallink4} className={team.socialicon4}></a>
              </li>
            </ul>
          </ReactWOW>
          <h3>{team.name}</h3>
